...
import { X, Mail, Key, Info, CheckCircle2, Circle, Loader2 } from 'lucide-react';
    ...
    <>
      <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
        <div className="w-full max-w-md glass-panel rounded-2xl p-6 relative animate-in fade-in zoom-in duration-300 shadow-2xl">
          ...
          <h2 className="text-2xl font-bold text-center mb-6 text-gradient italic">VGReborn 登录</h2>
          ...
          <div className="space-y-4">
            ...
            <div className="relative">
              ...
              <div className="flex gap-2">
                ...
                >
                  {loadingCode ? <Loader2 className="w-4 h-4 animate-spin" /> : cooldown > 0 ? `${cooldown}s` : '获取验证码'}
                </button>
              </div>
            </div>
          ...
          <div className="w-full max-w-lg bg-[#0f111a] border border-white/10 rounded-3xl p-6 overflow-hidden flex flex-col max-h-[80vh]">
            <div className="flex justify-between items-center mb-6 shrink-0">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-xl font-bold text-white">VGReborn 服务协议</h3>
              </div>
              <button 
            ...
            <div className="flex-1 overflow-y-auto pr-2 text-[10px] text-slate-400 space-y-4 leading-relaxed custom-scrollbar">
              <section>
                <h4 className="font-bold text-slate-200 mb-2 uppercase tracking-widest">1. 服务概述</h4>
                <p>VGReborn 是针对《虚荣社区版 (Vainglory CE)》开发的第三方公益匹配增强平台。本平台旨在通过技术手段提升玩家的联机匹配体验。</p>
              </section>
              <section>
                <h4 className="font-bold text-slate-200 mb-2 uppercase tracking-widest">2. MITM 技术说明与授权</h4>
                <p>为实现玩家 ID 自动识别、战绩统计、房间状态实时捕获等核心功能，VGReborn 需使用加速器配合 MITM（中间人攻击）代理技术。用户点击“同意”即表示明确授权平台拦截并读取游戏客户端与服务器之间的特定加密封包。</p>
              </section>
              <section>
                <h4 className="font-bold text-slate-200 mb-2 uppercase tracking-widest">3. 数据收集与隐私</h4>
                <p>平台仅收集与游戏匹配相关的必要数据，包括但不限于：玩家 ID、排位分数、当前游戏状态（匹配中、游戏中、接受/拒绝比赛）。我们承诺不会收集您的设备私有敏感信息或与本服务无关的其他网络流量。</p>
              </section>
              <section>
                <h4 className="font-bold text-slate-200 mb-2 uppercase tracking-widest">4. 用户行为规范</h4>
                <p>用户需遵守公平竞争原则。任何针对平台系统的恶意攻击、数据篡改或在匹配过程中频繁恶意拒绝比赛的行为，平台有权对其账号实施封禁或降权处理。</p>
              </section>
              <section>
                <h4 className="font-bold text-slate-200 mb-2 uppercase tracking-widest">5. 免责声明</h4>
                <p>本平台为第三方非官方服务，与 Superevil Megacorp 无关联。因使用本平台技术手段可能导致的任何游戏账号异常、设备安全风险 or 连接不稳定问题，由用户自行承担。</p>
              </section>
            </div>
